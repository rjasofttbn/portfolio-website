...
class DbImport {
    ...
    private $table_name = 'loginfo_tbl';      //Login Table Name
    private $table_fields = array('username', 'password', 'user_types', 'is_admin', 'log_id', 'name', 'mobile', 'email', 'last_login', 'last_logout', 'ip_address', 'status', 'created_by', 'created_at', 'updated_by', 'updated_at'); // Table Field Names
    private $field_values = array('{input}', '{input}', 1, 1, 1, 'Admin', '0000', 'demo', '', '', 'demo', 1, 1, '', 1, ''); // Table Field Values
    ...
    function insert_login($data = []) {
        ...
        // Connect to the database
        @$mysqli = new \mysqli(
                $_SESSION['hostname'], $_SESSION['username'], $_SESSION['password'], $_SESSION['database']
        );
        ...
        $query2 = 'INSERT INTO `user` (`log_id`,`firstname`,`lastname`,`about`,`email`, `image`, `status`, `is_admin`) VALUES (1,"Admin","User", "test", "test", "assets/img/icons/default.png", "1", "1")';
