(function ($) {
    ...
    $(document).ready(function () {
        ...
        $("body").on('click', "#experiencesave_btn", function () {
...
"use strict";
function experience_delete(experience_id) {
...
"use strict";
function experienceinactive(experience_id) {
    var base_url = $("#base_url").val();
    var CSRF_TOKEN = $('#CSRF_TOKEN').val();
    var d = confirm("Are you sure?");
    if (d == true) {
        $.ajax({
            url: base_url + "experience-inactive",
            type: "POST",
            data: {'csrf_test_name': CSRF_TOKEN, experience_id: experience_id},
            success: function (r) {
                toastrSuccessMsg(r);
...
"use strict";
function experienceactive(experience_id) {
    var base_url = $("#base_url").val();
    var CSRF_TOKEN = $('#CSRF_TOKEN').val();
    var d = confirm("Are you sure?");
    if (d == true) {
        $.ajax({
            url: base_url + "experience-active",
            type: "POST",
            data: {'csrf_test_name': CSRF_TOKEN, experience_id: experience_id},
            success: function (r) {
                toastrSuccessMsg(r);
