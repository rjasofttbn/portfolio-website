                        ...
                        <div class="tab-pane fade" id="v-pills-trainer" role="tabpanel" aria-labelledby="v-pills-trainer-tab">
                            <div class="form-group row m-r">
                                <div class="col-md-9">
                                            ...
                                            <div class="d-flex mt-2">
                                                <div class="flex-grow-1 px-3 row">
                                                    ...
                                                    <div class="form-group col-md-9">
                                                        <input type="text" class="form-control text_font" name="event_name[]" id="event_name[]" value="<?php echo html_escape($reuslt->name); ?>" placeholder="<?php echo display('name'); ?>">
                                                    </div>
                                    ...
                                    <button type="button" class="btn btn-success btn-sm custom_btn float-right" name="button" onclick="appendEvent()"> <i class="fa fa-plus"></i> </button>
                                </div>
                            </div>
                            <div class="offset-3 mb-3 group-end">
