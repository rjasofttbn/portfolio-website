<link rel="stylesheet" href="<?php echo base_url('application/modules/dashboard/assets/css/media_testimonial.css') ?>">
<div class="row">
    <!-- Form controls -->
    <div class="col-sm-12">
        <div class="card">
            ...
            <h4><?php echo html_escape((!empty($title) ? $title : null)) ?>
                    <small class="float-right">
                        <a href="<?php echo base_url('media_testimonial-list'); ?>" class="btn btn-primary" >
                            <?php echo display('media_testimonial_list'); ?>
                        </a>
                    </small>
                </h4>
            </div>
            <div class="row">
                ...
                <div class="col-sm-9 p-15">
                    <?php echo form_open_multipart('media_testimonial-update', 'class="myform" id="myform"'); ?>
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                            ...
                            <div class="offset-3 mb-3 group-end">
                                <input type="hidden" name="media_testimonial_id" value="<?php echo html_escape($edit_data->media_testimonial_id); ?>">
                                <input type="submit" class="btn btn-success" id="media_testimonialsave_btn" value="<?php echo display('update'); ?>">
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
