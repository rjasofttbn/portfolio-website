                ...
                <h4>
                    ...
                    <small class="float-right">
                        <a href="javascript:void(0);" class="btn btn-success" data-toggle="modal" data-target="#addModal">
                            <span class="fa fa-plus"> <?php echo display('add_sales_marketing'); ?></span> </a>
                    </small>
                </h4>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>
                                            <b> <?php echo display('add_sales_marketing') ?></b>
                                            <small class="float-right">
                                        ...
                                        <div class="col-sm-10 p-15">
                                            <form action="" method="post">
                                                <div class="form-group row">
                                                    <label for="section_type" class="col-sm-3 label font_bold"><?php echo display('section_type') ?><i class="text-danger"> *</i></label>
                                                    <div class="col-sm-8">
                                                        <select class="form-control text_font" name="section_type" id="section_type" required>
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-9 mb-3">
                                                        ...
                                                        <button type="button" class="btn btn-success text-white w-md m-b-5 font_bold" onclick="sales_marketing_save()"><?php echo display('save') ?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
            ...
            <div class="card-body results">
                <div class="table-responsive">
                    <table class="table display table-bordered table-striped table-hover bg-white m-0" id="example">
                        ...
                        <tbody>
                            <?php
                            if ($sales_marketing_list) {
                                $sl = 0;
                                foreach ($sales_marketing_list as $sales_marketing) {
                                    $sl++;
                            ?>
                                    <tr class="tbl_font">
                                        <td><?php echo $sl; ?></td>
                                        <td><?php
                                            if ($sales_marketing->section_type == 'sec_1') {
                                                echo 'Section 1';
                                            } else if ($sales_marketing->section_type == 'sec_2') {
                                                echo 'Section 2';
                                            } else if ($sales_marketing->section_type == 'sec_3') {
                                                echo 'Section 3';
                                            } else if ($sales_marketing->section_type == 'sec_4') {
                                                echo 'Section 4';
                                            } else if ($sales_marketing->section_type == 'sec_5') {
                                                echo 'Section 5';
                                            } else if ($sales_marketing->section_type == 'sec_6') {
                                                echo 'Section 6';
                                            } else if ($sales_marketing->section_type == 'sec_7') {
                                                echo 'Section 7';
                                            }
                                            ?></td>
                                        <td>
                                            <?php echo implode(' ', array_slice(explode(' ', htmlspecialchars_decode(html_escape($sales_marketing->title))), 0, 3)); ?>
                                        </td>
                                        <td>
                                            <?php echo substr(htmlspecialchars_decode(html_escape($sales_marketing->description)), 0, 30); ?>
                                        </td>
                                        <td>
                                            <img src="<?php echo base_url() . ((html_escape($sales_marketing->picture)) ? html_escape($sales_marketing->picture) : ('assets/img/icons/default.png')); ?>" alt="<?php echo html_escape($sales_marketing->title) ?>" width="55%">
                                        </td>
                                        <td>
                                            <?php
                                            if ($sales_marketing->status == 1) {
                                                echo 'Active';
                                            } else {
                                                echo 'Inactive';
                                            }
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($sales_marketing->status == 1) {
                                            ?>
                                                <a href='javascript:void(0)' onclick='sales_marketinginactive("<?php echo html_escape($sales_marketing->sales_marketing_id); ?>")' title='<?php echo display('disapprove'); ?>' class='btn btn-sm btn-success text-white'><i class='fa fa-check' aria-hidden='true'></i></a>
                                            <?php } elseif ($sales_marketing->status == 0) { ?>
                                                <a href='javascript:void(0)' onclick='sales_marketingactive("<?php echo html_escape($sales_marketing->sales_marketing_id); ?>")' title='<?php echo display('approve'); ?>' class='btn btn-sm btn-warning'><i class='fa fa-times' aria-hidden='true'></i></a>
                                            <?php
                                            } ?>
                                            <a href="javascript:void(0)" onclick="sales_marketing_edit('<?php echo html_escape($sales_marketing->sales_marketing_id); ?>')" class="btn btn-sm btn-success text-white"><i class="ti-pencil-alt"></i></a>

                                            <a class="btn-danger btn btn-sm" href="javascript:void(0)" onclick="sales_marketing_delete('<?php echo html_escape($sales_marketing->sales_marketing_id); ?>')"><i class="far fa-trash-alt"> </i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script src="<?php echo base_url('application/modules/dashboard/assets/js/sales_marketing.js') ?>"></script>
