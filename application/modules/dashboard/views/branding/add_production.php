<link rel="stylesheet" href="<?php echo base_url('application/modules/dashboard/assets/css/testimonial.css') ?>">
<div class="row">
    <div class="col-sm-12">
        <?php
        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 p-15">
                    <?php echo form_open_multipart('testimonial-save', 'class="myform" id="myform"'); ?>
                    ...
                    <div class="offset-3 mb-3 group-end">
                        <input type="submit" class="btn btn-success" id="testimonialsave_btn" value="<?php echo display('save'); ?>">
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
