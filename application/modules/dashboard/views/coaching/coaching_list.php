                ...
                <h4>
                    ...
                    <small class="float-right">
                        <a href="javascript:void(0);" class="btn btn-success" data-toggle="modal" data-target="#addModal">
                            <span class="fa fa-plus"> <?php echo display('add_coaching'); ?></span> </a>
                    </small>
                </h4>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>
                                            <b> <?php echo display('add_coaching') ?></b>
                                            <small class="float-right">
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-9 mb-3">
                                                        ...
                                                        <button type="button" class="btn btn-success text-white w-md m-b-5 font_bold" onclick="coaching_save()"><?php echo display('save') ?></button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                ...
                <div class="table-responsive">
                    <table class="table display table-bordered table-striped table-hover bg-white m-0" id="example">
                        ...
                        <tbody>
                            ...
                            if ($coaching_list) {
                                $sl = 0;
                                foreach ($coaching_list as $coaching) {
                                    $sl++;
                            ?>
                                    <tr class="tbl_font">
                                        <td><?php echo $sl; ?></td>
                                        <td><?php
                                            if ($coaching->section_type == 'sec_1') {
                                                echo 'Section 1';
                                            } else if ($coaching->section_type == 'sec_2') {
                                                echo 'Section 2';
                                            } else if ($coaching->section_type == 'sec_3') {
                                                echo 'Section 3';
                                            } else if ($coaching->section_type == 'sec_4') {
                                                echo 'Section 4';
                                            } else if ($coaching->section_type == 'sec_5') {
                                                echo 'Section 5';
                                            } else if ($coaching->section_type == 'sec_6') {
                                                echo 'Section 6';
                                            }
                                            ?></td>
                                        <td>
                                            <?php echo implode(' ', array_slice(explode(' ', htmlspecialchars_decode(html_escape($coaching->title))), 0, 3)); ?>
                                        </td>
                                        <td>
                                            <?php echo substr(htmlspecialchars_decode(html_escape($coaching->description)), 0, 30); ?>
                                        </td>
                                        <td>
                                            <img src="<?php echo base_url() . ((html_escape($coaching->picture)) ? html_escape($coaching->picture) : ('assets/img/icons/default.png')); ?>" alt="<?php echo html_escape($coaching->title) ?>" width="55%">
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td class="text-center">
                                            ...
                                            if ($coaching->status == 1) {
                                            ?>
                                                <a href='javascript:void(0)' onclick='coachinginactive("<?php echo html_escape($coaching->coaching_id); ?>")' title='<?php echo display('disapprove'); ?>' class='btn btn-sm btn-success text-white'><i class='fa fa-check' aria-hidden='true'></i></a>
                                            <?php } elseif ($coaching->status == 0) { ?>
                                                <a href='javascript:void(0)' onclick='coachingactive("<?php echo html_escape($coaching->coaching_id); ?>")' title='<?php echo display('approve'); ?>' class='btn btn-sm btn-warning'><i class='fa fa-times' aria-hidden='true'></i></a>
                                            <?php
                                            } ?>
                                            <a href="javascript:void(0)" onclick="coaching_edit('<?php echo html_escape($coaching->coaching_id); ?>')" class="btn btn-sm btn-success text-white"><i class="ti-pencil-alt"></i></a>

                                            <a class="btn-danger btn btn-sm" href="javascript:void(0)" onclick="coaching_delete('<?php echo html_escape($coaching->coaching_id); ?>')"><i class="far fa-trash-alt"> </i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script src="<?php echo base_url('application/modules/dashboard/assets/js/coaching.js') ?>"></script>
