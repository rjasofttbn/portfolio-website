<link rel="stylesheet" href="<?php echo base_url('application/modules/dashboard/assets/css/digital_media.css') ?>">
<div class="row">
    <!-- Form controls -->
    <div class="col-sm-12">
        <div class="card">
            ...
            <h4><?php echo html_escape((!empty($title) ? $title : null)) ?>
                    <small class="float-right">
                        <a href="<?php echo base_url('digital_media-list'); ?>" class="btn btn-primary" >
                            <?php echo display('digital_media_list'); ?>
                        </a>
                    </small>
                </h4>
            </div>
            <div class="row">
                ...
                <div class="col-sm-9 p-15">
                    <?php echo form_open_multipart('digital_media-update', 'class="myform" id="myform"'); ?>
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                            ...
                            <div class="offset-3 mb-3 group-end">
                                <input type="hidden" name="digital_media_id" value="<?php echo html_escape($edit_data->digital_media_id); ?>">
                                <input type="submit" class="btn btn-success" id="digital_mediasave_btn" value="<?php echo display('update'); ?>">
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
