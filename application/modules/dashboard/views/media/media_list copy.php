            ...
            <div class="card-header">
                <h4>
                    ...
                    <small class="float-right">
                        <a href="<?php echo base_url('add-media'); ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo base_url() . ((html_escape($media->picture)) ? html_escape($media->picture) : ('assets/img/icons/default.png')); ?>" alt="<?php echo html_escape($media->title) ?>" width="25%">
                                        </td>
                                        <td class="text-center">
                                            ...
                                            if ($this->permission->check_label('media_list')->update()->access()) {
                                                ?>
                                                <a class="btn btn-success btn-sm" href="<?php echo base_url('media-edit/' . html_escape($media->media_id)); ?>"><i class="fa fa-edit"> </i></a>
                                            <?php
                                            }
