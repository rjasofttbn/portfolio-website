        ...
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 p-15">
                    <?php echo form_open_multipart('about-save', 'class="myform" id="myform"'); ?>
                    ...
                    <div class="form-group row">
                        <label for="picture" class="col-sm-2"><?php echo display('picture') ?>
                            <span class="text-danger f-s-10">( 812×1082 )</span>
                        </label>
                        <div class="col-sm-8">
                            <div>
                    ...
                    <div class="offset-3 mb-3 group-end">
                        <input type="submit" class="btn btn-success" id="aboutsave_btn" value="<?php echo display('save'); ?>">
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
