<div class="panel panel-bd lobidrag">
    <div class="panel-heading">
        <div class="panel-title">
            <h6><?php echo display('stripe_configuration') ?></h6>
            <hr>
        </div>
    </div>
    <div class="panel-body">
        <form action="#" class="form-vertical" id="insert_customer" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" name="payment_method_name" class="form-control" id="stripe_method_name" value="<?php echo (!empty($get_configdata->payment_method_name) ? $get_configdata->payment_method_name : ''); ?>" placeholder="<?php echo display('payment_method'); ?>" tabindex="1" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="marchant_id" class="col-sm-3 col-form-label"><?php echo display('marchant_id'); ?></label>
                <div class="col-sm-6">
                    <input type="text" name="marchant_id" class="form-control" id="stripe_marchant_id" value="<?php echo (!empty($get_configdata->marchant_id) ? $get_configdata->marchant_id : ''); ?>" placeholder="<?php echo display('marchant_id'); ?>" tabindex="2">
                </div>
            </div>
            <div class="form-group row">
                <label for="password" class="col-sm-3 col-form-label"><?php echo display('password'); ?></label>
                <div class="col-sm-6">
                    <input type="text" name="password" class="form-control" id="stripe_password" value="<?php echo (!empty($get_configdata->password)) ? $get_configdata->password : ''; ?>" placeholder="<?php echo display('password'); ?>" tabindex="3">
                </div>
            </div>
            <div class="form-group row">
                <label for="email" class="col-sm-3 col-form-label"><?php echo display('email'); ?> </label>
                <div class="col-sm-6">
                    <input type="text" name="email" class="form-control" id="stripe_email" value="<?php echo (!empty($get_configdata->email) ? $get_configdata->email : ''); ?>" placeholder="<?php echo display('email'); ?>" tabindex="4" >
                </div>
            </div>
            <div class="form-group row">
                <label for="currency" class="col-sm-3 col-form-label"><?php echo display('currency'); ?> <span class="text-danger"> * </span></label>
                <div class="col-sm-6">
                    <select name="currency" class="form-control placeholder-single" id="stripe_currency">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name="is_live" id="stripe_is_live">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select class="form-control" name="status" id="stripe_status">
                        <option value="">-- select one -- </option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 text-right">
                    <input type="hidden" name="id" id="id" value="<?php echo (!empty($get_configdata->id) ? $get_configdata->id : ''); ?>">
                    <label>For Stripe Information</label>
                    <a href="https://stripe.com/docs" class="btn btn-success w-45"  target="_new">Go</a>
                    <input type="button" onclick="stripeconfigsave()" class="btn btn-info btn-large" value="<?php echo display('save'); ?>">
                </div>
            </div>
        </form>
    </div>
