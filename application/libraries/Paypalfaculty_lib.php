...
/**
 * Paypalfaculty_lib Controller Class (Paypal IPN Class)
 *
 ...
 *
 * The class requires the use of the Paypalfaculty_lib config file.
 *
 * @package     CodeIgniter
...
class Paypalfaculty_lib {
    ...
    function __construct() {
        ...
        $this->CI->load->config('paypalfacultylib_config');
    ...
    function add_field2($value) {
         $this->add_field('business',$value);
       // return $value;    
    }
    ...
    function paypal_auto_form() {
        ...
        echo '<body class="text-center"  onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
        echo '<p class="text-center">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
